...
export default function PyqContentEditor({
  ...
  const [bankRuleTestName, setBankRuleTestName] = useState("");
  ...
  async function createDraftQuizzesFromGeneratedSets() {
    ...
    const titleBase = String(bankRuleTestName || "").trim() || toTitleFromDocId(prefix);
              ...
              <>
                ...
                <div style={ui.bankRuleCard}>
                  ...
                  <div style={ui.bankRuleGrid}>
                    ...
                    <div>
                      <label style={ui.labelSmall}>Test Name</label>
                      <input
                        style={ui.input}
                        value={bankRuleTestName}
                        onChange={(e) => setBankRuleTestName(e.target.value)}
                        placeholder="SSC CGL Mock"
                      />
                    </div>
                    <div>
