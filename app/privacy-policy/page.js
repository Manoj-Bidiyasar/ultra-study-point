  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 text-gray-600 leading-relaxed space-y-6">
        ...
        <h3 className="text-gray-900 font-bold text-lg">Cookies</h3>
        <p>Like any other website, Ultra Study Point uses 'cookies' to store information including visitors' preferences and the pages on the website that the visitor accessed.</p>

        <h3 className="text-gray-900 font-bold text-lg">Consent</h3>
