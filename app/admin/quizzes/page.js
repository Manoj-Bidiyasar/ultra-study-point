...
const COLLECTION_PATH = ["artifacts", "ultra-study-point", "public", "data", "Quizzes"];
    ...
    <div style={styles.page}>
      ...
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.subtitle}>Manage tests, sections, and question banks</p>
        </div>
        <button onClick={() => router.push("/admin/quizzes/create")} style={styles.createBtn}>+ Create Quiz</button>
      </div>
            ...
            <tbody>
              {filtered.map((item) => (
                <tr key={item.id} style={styles.row}>
                  ...
                  <td style={styles.td}>{formatShortDate(item.updatedAt)}</td>
                  ...
                  <td style={styles.td}>
                    {filter !== "recently_deleted" && (
                      <>
                        <button style={styles.iconBtn} onClick={() => router.push(`/admin/quizzes/${item.id}`)}>Edit</button>
